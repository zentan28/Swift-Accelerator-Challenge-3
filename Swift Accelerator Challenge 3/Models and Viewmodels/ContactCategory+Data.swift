...
extension ContactCategory {
    static let sampleContactList = [
        ContactCategory(name: "Family", contacts: [Contact(name: "Bob", image: "placeholder1", birthday: Date(), phonenumber: "92706171", other: "Currently undergoing severe hypertension", notes: "", reminders: [])]),
